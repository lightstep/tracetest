...
type Test struct {
	...
	// Map using selector query as key, and an array of assertions as value
	Definition map[string][]Assertion `json:"definition,omitempty"`

	// Map using selector query as key, and an array of assertions as value
	ReferenceTestRunResult map[string][]Assertion `json:"referenceTestRunResult,omitempty"`
}
